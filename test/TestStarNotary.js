...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(await instance.tokenname.call(), "BRB Token");
    assert.equal(await instance.symbol.call(), "BRBT");
});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    const  name = await instance.lookUptokenIdToStarInfo(starId, {from: user1}); 
